...
Refresh, config reload, Lua restart, and agent restart solve different problems. This page is the behavioral guide; [CLI Reference](cli.md) lists every command and option.
