...
The command prints recent retained history and exits. Add `--follow` to subscribe directly to the running EasyBar app and every enabled helper agent. See the [Logs](../../../cli/easybar/logs.md) for every filter and output option.
