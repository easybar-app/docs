...
Each message exposes **Read** or **Unread** and, unless the publisher disables dismissal,
**Dismiss** actions below its content.
...
use [`easybar inbox`](../../../../cli/easybar/inbox.md) to send, inspect, update, dismiss, remove,
