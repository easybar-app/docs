...
For agent process checks, socket probes, permission issues, raw field inspection, and Homebrew service logs, use [Agent Diagnostics](../runtime/agent-diagnostics.md).
